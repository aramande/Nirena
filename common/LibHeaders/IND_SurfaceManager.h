...
in the library due tu its versatility. Suppose that we use  \b IndieLib to develop a game.
...
to make easier the scrolls creation, <b>the size of blocks</b>, in which the surface is
