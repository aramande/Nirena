...
// This class stores information about a button of the mouse
class CMouseButton
{
public:
	...
	{
		// If the button was pressed and is not pressed anymore we set the flag "released"
		if (mButtonState == IND_MBUTTON_PRESSED && pButtonState == IND_MBUTTON_NOT_PRESSED)	
			mReleased = 1;				

		// If the button was not pressed and now is pressed we set the flag "pressed"
